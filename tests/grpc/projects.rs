...
async fn test_mark_project_deleted() {
    ...
    let mark_deleted_resp = server.mark_project_deleted(Request::new(mark_deleted_req)).await.unwrap();
    ...
    let get_deleted_resp = server.get_projects_by_deletion_status(Request::new(get_deleted_req)).await.unwrap();
...
async fn test_reactivate_project() {
    ...
    server.mark_project_deleted(Request::new(mark_deleted_req)).await.unwrap();
    
    // Reactivate the project
    let reactivate_req = ReactivateProjectRequest {
        project_id: project_id.clone(),
    };
    let reactivate_resp = server.reactivate_project(Request::new(reactivate_req)).await.unwrap();
...
async fn test_get_projects_by_deletion_status() {
    ...
    server.mark_project_deleted(Request::new(mark_deleted_req1)).await.unwrap();
    
    let mark_deleted_req2 = MarkProjectDeletedRequest {
        project_id: project2_id.clone(),
    };
    server.mark_project_deleted(Request::new(mark_deleted_req2)).await.unwrap();
...
async fn test_permanently_delete_project() {
    ...
    let permanently_delete_resp = server.permanently_delete_project(Request::new(permanently_delete_req)).await.unwrap();
...
async fn test_mark_project_deleted_nonexistent() {
    ...
    let mark_deleted_resp = server.mark_project_deleted(Request::new(mark_deleted_req)).await;
...
async fn test_reactivate_project_nonexistent() {
    ...
    let reactivate_resp = server.reactivate_project(Request::new(reactivate_req)).await;
...
async fn test_project_deletion_workflow() {
    ...
    server.reactivate_project(Request::new(reactivate_req)).await.unwrap();
    ...
    server.permanently_delete_project(Request::new(permanently_delete_req)).await.unwrap();

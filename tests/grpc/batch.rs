...
async fn test_batch_archive_projects() {
    ...
    let get_active_resp = server.get_projects_by_deletion_status(Request::new(get_active_req)).await.unwrap();
    ...
    let batch_archive_resp = server.batch_mark_projects_as_archived(Request::new(batch_archive_req)).await.unwrap();
    ...
    let get_archived_resp = server.get_projects_by_deletion_status(Request::new(get_archived_req)).await.unwrap();
...
async fn test_batch_delete_projects() {
    ...
    server.batch_mark_projects_as_archived(Request::new(batch_archive_req)).await.unwrap();
    ...
    let batch_delete_resp = server.batch_delete_projects(Request::new(batch_delete_req)).await.unwrap();
...
async fn test_batch_tag_projects() {
    ...
    let batch_tag_resp = server.batch_tag_projects(Request::new(batch_tag_req)).await.unwrap();
...
async fn test_batch_untag_projects() {
    ...
    server.batch_tag_projects(Request::new(batch_tag_req)).await.unwrap();
    ...
    let batch_untag_resp = server.batch_untag_projects(Request::new(batch_untag_req)).await.unwrap();
...
async fn test_batch_add_projects_to_collection() {
    ...
    let collection_resp = server.create_collection(Request::new(collection_req)).await.unwrap();
    ...
    let batch_add_resp = server.batch_add_to_collection(Request::new(batch_add_req)).await.unwrap();
    ...
    let get_collection_resp = server.get_collection(Request::new(get_collection_req)).await.unwrap();
...
async fn test_batch_remove_projects_from_collection() {
    ...
    server.batch_add_to_collection(Request::new(batch_add_req)).await.unwrap();
    ...
    let batch_remove_resp = server.batch_remove_from_collection(Request::new(batch_remove_req)).await.unwrap();
...
async fn test_batch_create_collection_from_projects() {
    ...
    let batch_create_resp = server.batch_create_collection_from(Request::new(batch_create_req)).await.unwrap();
    ...
    assert_eq!(collection.notes, Some("Collection created from batch operation".to_string()));
...
async fn test_batch_update_task_status() {
    ...
    let get_tasks_resp = server.get_project_tasks(Request::new(get_tasks_req)).await.unwrap();
    ...
    let batch_update_resp = server.batch_update_task_status(Request::new(batch_update_req)).await.unwrap();
...
async fn test_batch_delete_tasks() {
    ...
    let batch_delete_resp = server.batch_delete_tasks(Request::new(batch_delete_req)).await.unwrap();
    let result = batch_delete_resp.into_inner();
...
async fn test_batch_operations_workflow() {
    ...
    let batch_create_collection_resp = server.batch_create_collection_from(Request::new(batch_create_collection_req)).await.unwrap();
    ...
    let batch_update_tasks_resp = server.batch_update_task_status(Request::new(batch_update_tasks_req)).await.unwrap();
